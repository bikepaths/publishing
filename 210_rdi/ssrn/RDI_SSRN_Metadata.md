...
1. Housing and Residential Economics eJournal
2. Public Health Law and Policy eJournal
3. State and Local Government eJournal
4. Economic Sociology eJournal
5. Social Capital, Networks & Trust eJournal
6. Poverty, Income Distribution & Social Protection eJournal

---

## Series Context

This paper is the fourth working paper in the Material Dignity Infrastructure series:
...
- **MDI-D (this paper)**: Relational Dignity Infrastructure — the human layer

MDI-C established the physical and operational architecture of the tower pipeline. This paper establishes the relational architecture that must operate within that physical environment for the pipeline to produce durable human outcomes rather than measured occupancy.
