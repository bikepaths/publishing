...
Preserving survival networks requires clustered unit allocation. Because standard placement relies on randomized lotteries, scattering populations destroys established mutual defense structures. On the street, trusted partners provide the baseline of physical safety. Severing these bonds at the facility threshold recreates the neurological emergency the housing intends to solve. Individuals arrive among strangers. Stripped of biological regulation, the nervous system classifies the environment as hostile and initiates defensive cycling.
