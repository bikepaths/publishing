# Chapter 5 Atomic Facts

## Section 1: The Monolith Category
- The word "homeless" combines structurally different groups into a single category.
- Politically and in the media, this categorization implies that a single universal solution is sufficient.
- The needs of a recently evicted individual living in a car differ from the medical needs of an individual with long-term untreated schizophrenia.

## Section 2: Clinical Diagnostic Errors
- Applying a single intervention model to a diverse population is clinically ineffective.
- Emergency shelters apply identical treatments to individuals with different presenting conditions.

## Section 3: The Deteriorating Species
- A segment of the unhoused population experiences biological and ontological collapse, which clinical teams call the "deteriorating species."
- This group lacks a realistic exit strategy from the street.
- The condition of the deteriorating species presents distinct clinical symptoms.
...
- Shelter environments require individuals to sleep near people experiencing drug withdrawal or hyper-vigilance.
- Sleep deprivation in shelters leads to job loss.
- Cities record shelter intakes and subsequent returns as separate successful interventions.
