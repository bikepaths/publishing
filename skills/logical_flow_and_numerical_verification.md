...
- Trace transitions between chapters to confirm a developmental progression of ideas.
- Verify that every paragraph establishes causal links with preceding sections.
- Identify abrupt thematic shifts or missing transitions that disrupt logical flow.
- Confirm that the argument moves from first-principles infrastructure to operational outcomes.
...
- Extract all numerical figures, percentages, dates, and currency values.
- Cross-reference numerical values across the chapter drafts, fact files, and epub sources.
- Match historical references, proper names, and statutory definitions across the whole corpus.
- Flag any mathematical discrepancies or naming variations.
