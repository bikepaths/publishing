...
*   **2.15:1 Aspect Ratio (Organic Framing Mandate):** All visual assets must be designed to survive a destructive post-generation 2.15:1 cinematic widescreen vertical crop. Generative models interpret mathematical percentages as literal lines, which ruins the image. Therefore, you MUST enforce the crop ratio using organic environmental framing. Direct the model with instructions similar to: "A sprawling vertical composition where the subject is centered horizontally, surrounded by massive, empty atmospheric space far above and far below." Never use mathematical framing terms like "30%" or "center axis" in the generation prompt.
