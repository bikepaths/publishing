...
*   **Macro-Document Scaling:** Abolish default four-paragraph geometry. Document length must scale linearly with subject complexity. Unpacking deep systemic friction requires extensive sequences spanning six or more paragraphs. Output volume must mirror causal density.
