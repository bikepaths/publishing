...
*   **Extreme Sentence Variance:** Mandate maximum syncopation. Use predominantly long sentences often hitting thirty words to build arguments. Cap each paragraph with an isolated sentence of variable length (three to eight words long).
*   **Terminal Syncopation:** Paragraph closing sentences must randomly alternate word counts between three and eight words. Consecutive paragraphs cannot share identical cap lengths. Force syntactic rotation across terminal sentences by alternating opening word classes.
