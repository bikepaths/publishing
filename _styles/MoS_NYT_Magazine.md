...
-   **Voice**: Third-person analytical voice, informed and present, but not a character in the narrative. Maintain a tone of rigorous observation rather than advocacy.
...
-   **Punctuation**: No em-dashes. Colons should not be used as hard stops within sentences; connect ideas through natural sentence movement or separate into distinct sentences.
-   **Paragraphs**: Paragraphs may be longer than contemporary standards, building a single sustained thought before moving to the next. This allows for deeper exploration of complex material.

## Vocabulary and Terminology
-   **Precision**: Use precise language. Technical terms should be introduced only when necessary and explained through context rather than explicit definition. Avoid jargon where possible.
-   **Accessibility**: The writing should be accessible to a general reader, assuming curiosity and seriousness but not prior specialized knowledge.

## Point of View
-   **Narrator**: An informed, unhurried narrator who stands slightly outside the story, offering a broad perspective. The narrator's presence is conveyed through the quality of attention to the material.
-   **Personal Experience**: The narrator does not insert personal experience.
...
## Prohibited Elements
-   Em-dashes.
-   Colons used as hard stops within sentences.
-   Excessive use of bullet points or numbered lists within the main narrative.
-   Overt advocacy or polemic tone.
