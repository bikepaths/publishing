...
- Staccato fragmentation. Sentences MUST flow with variable lengths. Do not create robotic, choppy sequences of short sentences.
...
moving to the next sentence, but ensure complex, flowing sentence structures using simple words and causal connections.
